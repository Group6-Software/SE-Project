...
class CustomerOrdersControllerTest < ActionController::TestCase
  ...
  test "should create customer_order" do
    assert_difference('CustomerOrder.count') do
      post :create, customer_order: { customerId: @customer_order.customerId, itemId: @customer_order.itemId, orderId: @customer_order.orderId }
    end
  ...
  test "should update customer_order" do
    patch :update, id: @customer_order, customer_order: { customerId: @customer_order.customerId, itemId: @customer_order.itemId, orderId: @customer_order.orderId }
    assert_redirected_to customer_order_path(assigns(:customer_order))
  end
